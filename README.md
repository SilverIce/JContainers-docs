...
- [LuaJIT extensions](https://luajit.org/extensions.html) and
  [FFI documentation](https://luajit.org/ext_ffi.html)
- [EmmyLua extension for Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=tangzx.emmylua)
